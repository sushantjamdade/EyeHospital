                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add Specialization<small>different form elements</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left" id="SpecialForm" autocomplete="off" enctype="multipart/form-data" name="SpecialForm" ng-submit="submitData(USpecialization)" novalidate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12"  autofocus placeholder="Desgnation." required name="name" id="name" ng-model="USpecialization.name" ng-minlength="3" ng-maxlength="20" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea class="form-control col-md-7 col-xs-12" placeholder="Address." name="address" id="address" ng-model="USpecialization.address"></textarea>
                                            </div>
                                        </div>
