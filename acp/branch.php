                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <p class="pull-right"><a class="btn btn-success btn-sm" href="" ng-show='add_branchbut' ng-click="add_branch()"><i class="fa fa-plus"></i> Add Branch</a>&nbsp;&nbsp;&nbsp;</p>
							  </p>
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left" id="BranchForm" autocomplete="off" enctype="multipart/form-data" name="BranchForm"  ng-show="add_form"  novalidate>
									 <h2>Add/update Branch Form</h2>
										...
										<div class="alert alert-success alert-dismissible fade in" ng-show="contentLoaded" role="alert">
										  ...
										  <input type="hidden" name="id" ng-model="id" value={{ branch.id }}> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="hname">Branch Name</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12"  autofocus placeholder="Branch Name." required name="name" id="name" ng-model="name" ng-minlength="3" ng-maxlength="20" />
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit"   class="btn btn-success" ng-disabled="BranchForm.$invalid" ng-show="add_but" ng-click="submitData()"/>Submit</button>
												<button  class="btn btn-success" ng-click="cancelData()" />cancel</button>
												<input type="button" class="btn btn-success" ng-show='update_br' value="Update" ng-click="update_branch()">
                                            </div>
...
<thead>
<h4 class="pull-left" ng-hide="list">List of Branch</h4>
<th>S.NO&nbsp;<a ng-click="sort_by('id')"><i class="icon-sort"></i></a></th>
<th>Branch Name&nbsp;<a ng-click="sort_by('name')"><i class="icon-sort"></i></a></th>
...
<tbody ng-init="get_branch()">
<tr ng-repeat="branch in pagedItems">
<td>{{ $index+1 }}</td>
<td>{{ branch.branch_name | uppercase }}</td>
<td>{{ branch.Address }}</td> 
<td>{{ branch.City }}</td>
<td>{{ branch.email_id }}</td>
<td>{{ branch.phone_no }}</td>
<td><a href="" ng-click="edit_branch(branch.id)">Edit</a> | <a href="" ng-click="delete_branch(branch.id)">Delete</a></td>
</tr> 
</tbody>
</table>
